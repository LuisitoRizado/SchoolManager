...
export const AlumnosPage = () => {
  ...
  <div className="row g-0">
  <div className="col-md-4">
    <img src="https://cdn-icons-png.flaticon.com/512/5965/5965185.png" className="img-fluid rounded-start" alt="..."/>
  </div>
  <div className="col-md-8">
    <div className="card-body">
    <h5 className="card-title">Dar baja temporal</h5>
      <p className="card-text">Puedes dar baja temporal a un alumno.</p>
